...
const Menu = () => {
    ...
    return (
        <div className={styles.menuContainer}>
            ...
            <div className={cx(styles.iconWrapper, {[styles.active]: activeMenuItem === MENU_ITEMS.RECTANGLE})} onClick={() => handleMenuClick(MENU_ITEMS.RECTANGLE)}>
                <FontAwesomeIcon icon={faSquare} className={styles.icon} />
            </div>
            <div className={cx(styles.iconWrapper, {[styles.active]: activeMenuItem === MENU_ITEMS.CIRCLE})} onClick={() => handleMenuClick(MENU_ITEMS.CIRCLE)}>
                <FontAwesomeIcon icon={faCircle} className={styles.icon} />
            </div>
            <div className={cx(styles.iconWrapper, {[styles.active]: activeMenuItem === MENU_ITEMS.LINE})} onClick={() => handleMenuClick(MENU_ITEMS.LINE)}>
            ...
            <div className={styles.iconWrapper} onClick={() => handleActioItemClick(MENU_ITEMS.CLEAR)}>
